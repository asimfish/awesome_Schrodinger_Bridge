...
- Reflected Schrödinger Bridge Matching（搜索摘要提及 ICLR 2026，约束域 SB）
- CytoBridge（平均场细胞相互作用 SB）、FreeBridge、MMDSBM、Departures（AAAI 2026，已在 reports/deep_research_learning_resources.md 收录）
